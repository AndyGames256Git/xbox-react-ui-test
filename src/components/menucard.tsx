...
export const MenuCards = () => {
  return (
    <div className="flex items-center justify-between space-x-4">
      <div className="relative outlined outline-offset-0 rounded-lg w-[350px] h-[200px] group flex flex-col items-center justify-center bg-primary/80">
      ...
      <div
        className="relative outlined outline-offset-0 rounded-lg w-[350px] h-[200px] group flex flex-col items-center justify-center bg-primary/80"
        style={{
