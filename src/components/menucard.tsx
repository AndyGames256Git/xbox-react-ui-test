...
export const MenuCards = () => {
  return (
    <div className="flex items-center justify-between space-x-4">
      <div className="relative border-4 border-hidden rounded-lg w-[350px] h-[200px] group hover:border-solid hover:border-secondary flex flex-col items-center justify-center bg-primary/80">
      ...
      <div
        className="relative border-4 border-hidden rounded-lg w-[350px] h-[200px] group hover:border-solid hover:border-secondary"
        style={{
